                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            ...
                            <h3 class="mb-4">Anugerah Chandra P</h3>
                            <p class="testimonial">
                                " It was glorious and I could not stop to
                                say wohoo for
                                every single moment Dankeeeee "
                            </p>
                        </div>
                        <hr>
                        <p class="trip-to mt-2"> Trip to Denpasar, Bali</p>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            ...
                            <h3 class="mb-4">Angga Budi S</h3>
                            <p class="testimonial">
                                " The trip was amazing and
                                I saw something beautiful in
                                the island that makes me happy"
                            </p>
                        </div>
                        <hr>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            ...
                            <h3 class="mb-4">Habibatul Rohma</h3>
                            <p class="testimonial">
